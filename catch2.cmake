# Downloads and compiles Catch2 unit testing framework
find_package(Catch2 QUIET)
if(Catch2_FOUND)
    message(STATUS "Found Catch2: ${Catch2_SOURCE_DIR}")
else(Catch2_FOUND)
    message(STATUS "Failed to find Catch2, going to fetch from source")
    ...
    FetchContent_Declare(Catch2
        ...
        GIT_TAG v3.9.0    # "devel" for latest
